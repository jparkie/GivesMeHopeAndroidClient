...
public class MainActivityTestWithBadGMHInterpreterModule {
    public static final String TAG = MainActivityTestWithBadGMHInterpreterModule.class.getSimpleName();
    ...
    @Before
    public void setUp() {
        prepareTestWithBadGMHInterpreterModule();
    ...
    private void prepareTestWithBadGMHInterpreterModule() {
